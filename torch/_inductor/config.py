...
# When > 0, combo kernel creation simulates each group's peak memory impact
# and rejects (or greedily shrinks) groups whose simulated peak exceeds
# baseline + threshold (bytes). 0 disables the check.

...
{code}"""
    ...
    # an explicit _CodeGenContext instead of captured locals, and produce
    # *uncolored* output (matching the default colored=False behaviour).
    #
    # The base _gen_python_code() intentionally does NOT call these —
    # it keeps its own closures to preserve the colored/verbose path and
    # guarantee zero behaviour change.
    # ------------------------------------------------------------------
